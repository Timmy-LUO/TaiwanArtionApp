...
final public class FilterPositionButtons: UICollectionView {
    ...
    convenience init() {
        ...
        register(FilterPositionButtonsCell.self, forCellWithReuseIdentifier: FilterPositionButtonsCell.identifier)
...
extension FilterPositionButtons: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FilterPositionButtonsCell.identifier, for: indexPath) as! FilterPositionButtonsCell
