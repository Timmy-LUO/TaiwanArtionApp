...
final public class NorthAreaButtons: UICollectionView {
    ...
    convenience init() {
        ...
        register(NorthAreaButtonsCell.self, forCellWithReuseIdentifier: NorthAreaButtonsCell.identifier)
...
extension NorthAreaButtons: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: NorthAreaButtonsCell.identifier, for: indexPath) as! NorthAreaButtonsCell
