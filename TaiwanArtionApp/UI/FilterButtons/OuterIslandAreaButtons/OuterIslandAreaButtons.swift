...
final public class OuterIslandAreaButtons: UICollectionView {
    ...
    convenience init() {
        ...
        register(OuterIslandAreaButtonsCell.self, forCellWithReuseIdentifier: OuterIslandAreaButtonsCell.identifier)
...
extension OuterIslandAreaButtons: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: OuterIslandAreaButtonsCell.identifier, for: indexPath) as! OuterIslandAreaButtonsCell
