...
final public class EastAreaButtons: UICollectionView {
    ...
    convenience init() {
        ...
        register(EastAreaButtonsCell.self, forCellWithReuseIdentifier: EastAreaButtonsCell.identifier)
...
extension EastAreaButtons: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: EastAreaButtonsCell.identifier, for: indexPath) as! EastAreaButtonsCell
