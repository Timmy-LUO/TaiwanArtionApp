...
final public class SouthAreaButtons: UICollectionView {
    ...
    convenience init() {
        ...
        register(SouthAreaButtonsCell.self, forCellWithReuseIdentifier: SouthAreaButtonsCell.identifier)
...
extension SouthAreaButtons: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: SouthAreaButtonsCell.identifier, for: indexPath) as! SouthAreaButtonsCell
